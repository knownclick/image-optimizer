...
from image_optimizer.cli.commands.convert import convert_cmd
from image_optimizer.cli.commands.resize import resize_cmd
from image_optimizer.cli.commands.crop import crop_cmd
from image_optimizer.cli.commands.compress import compress_cmd
from image_optimizer.cli.commands.thumbnail import thumbnail_cmd
from image_optimizer.cli.commands.metadata import metadata_group
from image_optimizer.cli.commands.favicon import favicon_cmd
from image_optimizer.cli.commands.bulk import bulk_group
...
def main(ctx: click.Context, gui: bool) -> None:
    ...
    if gui:
        try:
            from image_optimizer.gui import launch_gui
            launch_gui()
...
main.add_command(crop_cmd, "crop")
