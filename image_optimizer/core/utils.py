...
from image_optimizer.core.constants import SUPPORTED_EXTENSIONS
...
def ensure_avif_support() -> bool:
    """Check AVIF support — native Pillow (10.1+) or pillow-avif-plugin."""
    global _avif_available
    if _avif_available is None:
        # Check native Pillow AVIF support first (Pillow >= 10.1)
        try:
            ...
            pass
        # Fall back to pillow-avif-plugin
        try:
