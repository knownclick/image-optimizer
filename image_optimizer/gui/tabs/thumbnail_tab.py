...
from image_optimizer.gui.components.settings_panel import FormatSelector, QualitySlider
...
from image_optimizer.core.types import BulkResult, OverwritePolicy


class ThumbnailTab(ScrollableFixMixin, ctk.CTkScrollableFrame):
    ...
    def _on_complete(self, results):
        ...
        self._result.show_bulk_result(bulk)
