"""mediamanager resize — single file resize."""
...
from mediamanager.core.types import MediaManagerError, OverwritePolicy, ResizeMode
...
def resize_cmd(input_file, output_file, width, height, percentage, mode, fmt, quality, overwrite):
    ...
    try:
        from mediamanager.core.resizer import resize_image
        result = resize_image(
